  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        Center(
            child: ListTile(
                title: Text('Chat and Flirt', style: TextStyle(fontSize: 16.0)),
                leading: Icon(Icons.chat))),
        Center(
            child: ListTile(
                title:
                    Text('Make new Friends', style: TextStyle(fontSize: 16.0)),
                leading: Icon(Icons.people))),
        Center(
            child: ListTile(
                title: Text('Find new Love', style: TextStyle(fontSize: 16.0)),
